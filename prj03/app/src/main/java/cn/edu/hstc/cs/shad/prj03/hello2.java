...
public class hello2 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobjCount=objCount;
        settupClick();
        Log.d(myMsg, "onCreate Hello2 execute"+mobjCount);
    }
    @Override
    protected void onStart() {
        super.onStart();
        Log.d(myMsg, "onStart Hello2 execute"+mobjCount);
    ...
    protected void onPause() {
        super.onPause();
        Log.d(myMsg, "onPause Hello2 execute"+mobjCount);
    ...
    protected void onStop() {
        super.onStop();
        Log.d(myMsg, "onStop Hello2 execute"+mobjCount);
    ...
    protected void onResume() {
        super.onResume();
        Log.d(myMsg, "onResume Hello2 execute"+mobjCount);
    ...
    protected void onDestroy() {
        ...
        //每次onDestroy活动-1
        objCount--;
        Log.d(myMsg, "onDestroy Hello2 execute"+mobjCount);
